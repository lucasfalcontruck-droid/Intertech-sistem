...
/** app/api/estoque/products/route.ts — Área Estoque: listagem e criação de produtos acabados. */
...
/** Cria um novo produto, já vinculando os canais de venda selecionados. */
